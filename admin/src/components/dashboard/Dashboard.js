    ...
    <div className={`container ${isNavClosed ? 'nav-closed' : ''}`}>
      <div className="header">
        <div className="header-logo">
          ...
          <span className="site-title">Akbar</span>
        </div>
      ...
      <div className="main">
        <div className="sidebar" onClick={closeNavOnMobile}>
          <ul>
            <li><a href="#" className="active"><i className="lni lni-home"></i><span>Dashboard</span></a></li>
            <li><a><i className="lni lni-text-format"></i><span onClick={() => handleComponentClick('Instructor')} style={{cursor:"pointer"}}>All Instructors</span></a></li>

            <li><a href="#"><i className="lni lni-bar-chart"></i><span onClick={() => handleComponentClick('AddCourse')} style={{cursor:"pointer"}}>Add Course</span></a></li>

          </ul>
        </div>
        <div className="page-content" onClick={closeNavOnMobile}>
          {/* <h1>Welcome back, John!</h1> */}
          {selectedComponent === 'Instructor' && <Instructor />}
          {selectedComponent === 'AddCourse' && <AddCourse />}
        </div>
      </div>
    </div>
  );
